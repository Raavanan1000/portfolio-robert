...
{
  icon: Palette,
  title: 'Grading Software',
  tools: ['DaVinci Resolve Studio', 'Baselight', 'FilmLight Prelight']
},
{
  icon: Monitor,
  title: 'Reference Monitors',
  tools: ['Sony BVM-X300', 'Flanders Scientific XM311K', 'LG OLED C2 (HDR)']
},
{
  icon: Cpu,
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">
            Tools & <span className="text-cosmic-cyan">Workflow</span>
          </h2>
          <p className="text-cinema-muted text-lg max-w-2xl mx-auto">
            Professional-grade equipment and industry-standard workflows ensure
        ...
        <motion.div
          ...
          <p className="text-cinema-muted text-sm max-w-3xl mx-auto leading-relaxed">
            All work is performed in a calibrated, color-managed environment. I
            deliver in any format required: DCP, ProRes, DNxHR, or raw footage
            with LUTs.
          </p>
        </motion.div>
      </div>
